...
export const patchs: Patch[] = [
  {
    date: Number(new Date("2026-06-08")),
    name: "강택 서비스 종료 안내",
    developerNote: "서버 운영비(EC2/DB) 문제로 2026-06-19(금) 서비스 종료.",
    isPublic: true,
    content: `**🚖 강택 서비스 종료 안내**

안녕하세요, 강택 팀입니다.
오랜만에 공지로 찾아뵙게 되었지만, 아쉽게도 강택 서비스 종료 소식을 전해드리게 되었습니다.

강택은 서버 운영 비용 등 내부 운영상의 이유로 인해 **2026년 6월 19일(금)**을 마지막으로 서비스를 종료합니다.

✅ 안내사항
- 6월 19일(금) 이후 앱 및 모든 서비스 이용이 중단됩니다.
- 종료 이후에는 카풀 매칭 및 파티 참여가 불가능합니다.
- 종료일 전까지는 평소와 동일하게 이용하실 수 있습니다.

그동안 강택(KNU Carpool)을 이용해주시고 관심 가져주신 학우분들께 진심으로 감사드립니다.
`,
  },
  {
